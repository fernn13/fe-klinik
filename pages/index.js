            ...
            <div className="grid">
                <div className="col-12 lg:col-4 my-2">
                    <div className="card">
                        <div className="flex justify-content-between">
                            <div>
                                <span className="block text-700 font-medium text-xl">Total Kamar</span>
                                <div className="text-900 font-medium text-5xl text-center">{dataDash.totKamar}</div>
                            </div>
                            <div className="flex align-items-center">
                                <i className="pi pi-home text-7xl"></i>
                            </div>
                        </div>
                ...
                <div className="col-12 lg:col-4 my-2">
                    <div className="card">
                        <div className="flex justify-content-between">
                            <div>
                                <span className="block text-700 font-medium text-xl">Kamar Tersedia</span>

        ...
        >
            <div className="w-11 md:w-10 mx-4" style={{ minWidth: '300px' }}>
                <div className="grid shadow-5 border-round" style={{ backgroundColor: 'var(--surface-card)' }}>
                    {/* Form Column */}
                    <div className="col-12 lg:col-5 p-6 flex flex-column justify-content-center items-center">
                        <div>
                            <div className="text-center mb-6">
                                {/* <img src="layout/images/2.png" alt="logo" className="mb-4" style={{ height: '50px' }} />
                                <img src="layout/images/1.png" alt="logo" className="mb-4" style={{ height: '50px' }} /> */}
                                <div className="text-900 text-3xl font-medium mb-3">Clinic System</div>
                            </div>
                            ...
                            <form onSubmit={formik.handleSubmit} className="p-fluid">
                                ...
                                <button
                                    ...
                                    className={`flex align-items-center justify-content-between gap-2 px-4 rounded bg-green-500 text-white font-medium shadow-md hover:bg-green-600 disabled:bg-gray-400 disabled:cursor-not-allowed transition w-full`}
                                    disabled={loading}
                                    type="submit"
                                >
                                    <>
                    ...
                    <div className="col-12 lg:col-7 hidden lg:flex p-0">
                        <img
                            src={`/layout/images/${layoutConfig.colorScheme === 'light' ? 'hero-loginclinic' : 'hero-loginclinic'}.png`}
                            alt="Gambar"
